...
public class Sachemhoardstalker extends Familiar {
	...
	public Sachemhoardstalker(Player owner, Pouch pouch, WorldTile tile, int mapAreaNameHash, boolean canBeAttackFromOutOfArea) {
	...
	public void processNPC() {
		...
		if (forageTicks == 300) {
			forageTicks = 0;
			getBob().getBeastItems().add(new Item(DungeonConstants.HOARDSTALKER_ITEMS[9][Utils.random(5)], 1));
		}
	}
