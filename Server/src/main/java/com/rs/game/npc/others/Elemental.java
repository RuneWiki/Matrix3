...
public class Elemental extends NPC {
	...
	private static final WorldTile[][] tiles =
	{
		...
		{
			new WorldTile(2918, 5483, 0),
			new WorldTile(2918, 5485, 0),
			new WorldTile(2915, 5485, 0),
			new WorldTile(2915, 5483, 0),
			new WorldTile(2912, 5483, 0),
			new WorldTile(2912, 5485, 0),
			new WorldTile(2915, 5485, 0),
			new WorldTile(2915, 5483, 0) },
		...
		{ new WorldTile(2899, 5466, 0), new WorldTile(2899, 5468, 0), new WorldTile(2897, 5468, 0), new WorldTile(2897, 5466, 0), new WorldTile(2897, 5468, 0), new WorldTile(2899, 5468, 0) },
		...
		{ new WorldTile(2896, 5483, 0), new WorldTile(2900, 5483, 0), new WorldTile(2900, 5480, 0), new WorldTile(2897, 5480, 0), new WorldTile(2896, 5482, 0) },
	...
	public void processNPC() {
		if (!beingTeleported) {
			for (Entity t : getPossibleTargets()) {
				if (withinDistance(t, 2) && Utils.getAngle(t.getX() - getX(), t.getY() - getY()) == getDirection()) {
