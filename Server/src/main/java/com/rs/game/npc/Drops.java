...
public class Drops {
	...
	public static final Drop[] RARE_DROP_TABLE =
	{
		...
		new Drop(270, 10, 100),
		new Drop(454, 150, 7500),
		new Drop(450, 150, 800),
		new Drop(7937, 100, 14500),
		new Drop(1441, 25, 35),
		new Drop(1443, 25, 36),
		new Drop(1444, 1, 1),
		new Drop(372, 125, 1000),
		new Drop(383, 250, 500),
		new Drop(5321, 3, 3),
		new Drop(1631, 1, 1),
		new Drop(1615, 1, 1),
		new Drop(1391, 200, 200),
		new Drop(574, 1000, 1000),
		new Drop(570, 1000, 1000),
		new Drop(451, 1, 100),
		new Drop(2362, 1450, 7000),
		new Drop(2364, 1, 150),
		new Drop(5315, 1, 50),
		new Drop(5316, 1, 6),
		new Drop(5289, 10, 10),
