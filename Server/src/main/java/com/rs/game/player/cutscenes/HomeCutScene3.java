...
public class HomeCutScene3 extends Cutscene {
	...
	public CutsceneAction[] getActions(final Player player) {
		...
		actionsList.add(new NPCForceTalkAction(ADVERTISER, "Doesn't matter! My job is to introduce new players to the Oracle of Dawn.", 10));
		actionsList.add(new PlayerForceTalkAction("And who's that?", 3));
		actionsList.add(new NPCForceTalkAction(ADVERTISER, "Stop asking so many questions... I don't have time for that!", 5));
		actionsList.add(new NPCForceTalkAction(ADVERTISER, "Just come closer and I will show you.", 3));
		...
		actionsList.add(new NPCForceTalkAction(ORACLE, "As you may have noticed, you're dreaming.", 3));
		actionsList.add(new NPCForceTalkAction(ORACLE, "Allow me to show you the world of CorruptionX.", 3));
		actionsList.add(new PlayerForceTalkAction("But I don't want... Let me play already!", 3));
		...
		actionsList.add(new PlayerForceTalkAction("Stop teleporting me already...", 3));
		...
		actionsList.add(new PlayerForceTalkAction("I don't even care anymore....", 3));
		actionsList.add(new NPCForceTalkAction(ORACLE, "Sawmill. If your goal is to become the #1 woodcutter, this is where you belong. Let's continue.", 5));

		actionsList.add(new MovePlayerAction(3668, 5082, 0, Player.TELE_MOVE_TYPE, -1));
		actionsList.add(new NPCForceTalkAction(ORACLE, "Living Rock Caverns. Here the most enslaved players pass their day mining and fishing for the others.", 5));
		...
		actionsList.add(new NPCForceTalkAction(ORACLE, "CorruptionX has many beasts (beast players too) aswell.", 5));
		...
		actionsList.add(new NPCForceTalkAction(ORACLE, "Talk to me anytime, if you need any help!", 5));
