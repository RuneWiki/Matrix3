...
public class Trade {
	...
	public void sendOptions() {
		...
		player.getPackets().sendInterSetItemsOptionsScript(335, 24, 90, 4, 7, "Remove", "Remove-5", "Remove-10", "Remove-All", "Remove-X", "Value");
		player.getPackets().sendInterSetItemsOptionsScript(335, 27, 90, true, 4, 7, "Value");
