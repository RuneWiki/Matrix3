...
public class FriendsChat {
	...
	public static void requestJoin(Player player, String name) {
		...
		LoginClientChannelManager.sendReliablePacket(LoginChannelsPacketEncoder.encodePlayerFriendsChatJoinLeaveRequest(player.getUsername(), name).getBuffer());
	}
	...
	public static void requestLeave(Player player) {
		LoginClientChannelManager.sendReliablePacket(LoginChannelsPacketEncoder.encodePlayerFriendsChatJoinLeaveRequest(player.getUsername(), null).getBuffer());
	}
	...
	public void sendMessage(Player player, String message) {
		LoginClientChannelManager.sendReliablePacket(LoginChannelsPacketEncoder.encodePlayerFriendsChatMessageRequest(player.getUsername(), message).getBuffer());
	}
	...
	public void sendMessage(Player player, QuickChatOptionDefinition option, long[] qcData) {
		LoginClientChannelManager.sendReliablePacket(LoginChannelsPacketEncoder.encodePlayerFriendsChatMessageRequest(player, option, qcData).getBuffer());
	}
	...
	public void kickMember(Player player, String target) {
		LoginClientChannelManager.sendReliablePacket(LoginChannelsPacketEncoder.encodePlayerFriendsChatKickRequest(player.getUsername(), target).getBuffer());
	}
	...
	public void toogleLootshare(Player player) {
		if (player.isLootShareEnabled())
			...
			LoginClientChannelManager.sendReliablePacket(LoginChannelsPacketEncoder.encodePlayerFriendsChatLootshareRequest(player.getUsername()).getBuffer());
		}
	}
