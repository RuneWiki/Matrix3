...
public class FriendsIgnores {
	...
	public void addFriend(String displayName) {
		LoginClientChannelManager.sendReliablePacket(LoginChannelsPacketEncoder.encodePlayerFriendIgnoreOperation(player.getUsername(), displayName, LoginProtocol.FRIENDIGNORE_OP_FADD).getBuffer());
	}
	...
	public void removeFriend(String displayName) {
		...
		LoginClientChannelManager.sendReliablePacket(LoginChannelsPacketEncoder.encodePlayerFriendIgnoreOperation(player.getUsername(), displayName, LoginProtocol.FRIENDIGNORE_OP_FREMOVE).getBuffer());
	}
	...
	public void addIgnore(String displayName, boolean temp) {
		LoginClientChannelManager.sendReliablePacket(LoginChannelsPacketEncoder.encodePlayerFriendIgnoreOperation(player.getUsername(), displayName, temp ? LoginProtocol.FRIENDIGNORE_OP_IADDTMP : LoginProtocol.FRIENDIGNORE_OP_IADD).getBuffer());
	}
	...
	public void removeIgnore(String displayName) {
		...
		LoginClientChannelManager.sendReliablePacket(LoginChannelsPacketEncoder.encodePlayerFriendIgnoreOperation(player.getUsername(), displayName, LoginProtocol.FRIENDIGNORE_OP_IREMOVE).getBuffer());
	}
	...
	public void changeRank(String displayName, int newRank) {
		LoginClientChannelManager.sendReliablePacket(LoginChannelsPacketEncoder.encodePlayerFriendIgnoreSetRank(player.getUsername(), displayName, newRank).getBuffer());
	}
	...
	public void handleFriendChatButtons(int interfaceId, int componentId, int packetId) {
		if (interfaceId == 1427 || interfaceId == 1109 || interfaceId == 1472 || interfaceId == 1468) {
			...
			} else if ((interfaceId == 1427 && componentId == 4) || (interfaceId == 1109 && componentId == 4)) {
