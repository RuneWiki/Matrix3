...
public class PotteryFurnace extends Dialogue {
	...
	@Override
	public void start() {
		SkillsDialogueOld.sendSkillsDialogue(player, SkillsDialogueOld.MAKE, "How many hides would you like to tan?<br>Choose a number, then click the pot to begin.", 28, PRODUCTS, new ItemNameFilter() {
			int count = 0;
