...
public class ItemRemover {
	...
	{ 15486, 15487, 7398, 7399, 7400, 6889, 6890, 560, 565, 9075, 21773, 6914, 6915, 2436, 2437, 2440, 2441, 2442, 2443, 2444, 2445, 3040, 3041, 6685, 6686, 3024, 3025, 2434, 2435, 21630, 21631 };
	...
	private static void removeItems(Player player, int[] items) {
		for (int id : items) {
			...
			if (amt > 0) {
				...
				player.getInventory().addItemMoneyPouch(new Item(995, ItemDefinitions.getItemDefinitions(id).value * amt));
			}
	...
	public static void check(Player player) {// WARNING: Don't use else if or else it won't end up well :D
