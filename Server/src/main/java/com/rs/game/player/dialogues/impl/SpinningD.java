...
public class SpinningD extends Dialogue {
	...
	public void start() {
		...
		SkillsDialogueOld.sendSkillsDialogue(player, SkillsDialogueOld.MAKE, "How many strings would you like to make?<br>Choose a number, then click the string to begin.", 28, PRODUCT[dung ? 1 : 0], new ItemNameFilter() {
			int count = 0;
