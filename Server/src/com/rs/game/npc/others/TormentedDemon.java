...
public final class TormentedDemon extends NPC {
	...
	private void sendRandomProjectile() {
		...
		Projectile projectile = World.sendProjectileNew(this, tile, 1884, 34, 0, 40, 1, 16, 0);
		...
		World.sendGraphics(this, new Graphics(1883, projectile.getEndTime(), 0, 0, true), tile);
	}
