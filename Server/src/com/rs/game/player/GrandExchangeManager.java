...
public class GrandExchangeManager implements Serializable {
	...
	public void openHistory() {
		...
		for (int i = 0; i < history.length; i++) {
			...
			player.getPackets().sendIComponentText(643, 9 + i, o == null ? "" : o.isBought() ? "You bought" : "You sold");
			player.getPackets().sendIComponentText(643, 19 + i, o == null ? "" : ItemDefinitions.getItemDefinitions(o.getId()).getName());
			player.getPackets().sendIComponentText(643, 14 + i, o == null ? "" : Utils.getFormattedNumber(o.getQuantity()));
			player.getPackets().sendIComponentText(643, 24 + i, o == null ? "" : Utils.getFormattedNumber(o.getPrice()));
		}
	}
	...
	public void setItem(Item item, boolean sell) {
		if (item.getId() == Shop.COINS || (!ItemConstants.isTradeable(item) && item.getId() != Settings.VOTE_TOKENS_ITEM_ID)) {
