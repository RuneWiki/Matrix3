...
public class DZGuideScene extends Cutscene {
	...
	public CutsceneAction[] getActions(Player player) {
		...
		actionsList.add(new MovePlayerAction(3787, 4360, 1, Player.TELE_MOVE_TYPE, 0));
		...
		actionsList.add(new DialogueAction("Zone 1 - Entrance: You can find grand exchange and teleports here."));
		
		actionsList.add(new LookCameraAction(3753, 4387, 1000, 6, 6, -1));
		actionsList.add(new PosCameraAction(3767, 4385, 5000, 6, 6, 3));
		
		actionsList.add(new MovePlayerAction(3768, 4385, 1, Player.TELE_MOVE_TYPE, 0));
		actionsList.add(new MovePlayerAction(3757, 4394, false, 10));
		
		actionsList.add(new DialogueAction("Zone 2 - Mining site: You can find all kind of rocks here. Plus, mineral deposits wont deplete."));

		
		actionsList.add(new LookCameraAction(3757, 4418, 1000, 6, 6, -1));
		actionsList.add(new PosCameraAction(3757, 4406, 1500, 6, 6, 3));
		
		actionsList.add(new MovePlayerAction(3757, 4403, 1, Player.TELE_MOVE_TYPE, 0));
		actionsList.add(new MovePlayerAction(3757, 4419, false, 10));
		
		actionsList.add(new DialogueAction("Zone 3 - Runecrafting / Construction / Prayer: You can find rune essence mines, zmi altar, portals to runespan, guilded altar and set your house here."));
		...
		actionsList.add(new MovePlayerAction(3768, 4429, 1, Player.TELE_MOVE_TYPE, 0));
		actionsList.add(new MovePlayerAction(3785, 4429, false, 10));
		
		actionsList.add(new DialogueAction("Zone 4 - Woodcutting. Every tree you could hope for is here! You can always go back to sawmill if you don't like it here."));
		...
		actionsList.add(new MovePlayerAction(3807, 4417, 1, Player.TELE_MOVE_TYPE, 0));
		actionsList.add(new MovePlayerAction(3807, 4405, false, 10));
		
		actionsList.add(new DialogueAction("Zone 5 - Fishing. Fish, fish, fish!"));

		actionsList.add(new MovePlayerAction(3810, 4393, 1, Player.TELE_MOVE_TYPE, 0));
		actionsList.add(new LookCameraAction(3811, 4380, 1000, -1, -1, -1));
		actionsList.add(new PosCameraAction(3811, 4380, 10000, -1, -1, -1));
		
		actionsList.add(new DialogueAction("Zone 6 - Crafting/Smith/Cooking/Firemaking. Lots of things to do here!"));
		
		
		actionsList.add(new MovePlayerAction(3787, 4388, 1, Player.TELE_MOVE_TYPE, 0));
		
		actionsList.add(new LookCameraAction(3787, 4402, 1000, -1, -1, -1));
		actionsList.add(new PosCameraAction(3787, 4393, 1500, -1, -1, -1));
		
		
		actionsList.add(new DialogueAction("Zone 7 - Obelisk! Train your summoning here!"));
		...
		actionsList.add(new DialogueAction("And this concludes donator zone tutorial."));
		actionsList.add(new DialogueAction("If you want to replay this scene talk to me again."));
