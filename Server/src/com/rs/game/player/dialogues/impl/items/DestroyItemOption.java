...
public class DestroyItemOption extends Dialogue {
	...
	public void start() {
		...
		player.getPackets().sendHideIComponent(1183, 8, player.getInventory().getAmountOf(item.getId()) == 1);
		player.getPackets().sendIComponentText(1183, 9, ItemDestroys.getDestroy(item));
