...
public final class EmotesManager implements Serializable {
	...
	private void refreshListConfigs() {
		if (unlockedEmotes.contains(24) && unlockedEmotes.contains(25))
			player.getVarsManager().sendVarOld(465, 7); // goblin quest emotes
		int value1 = 0;
		...
		if (unlockedEmotes.contains(31))
			value1 += 8;
		if (value1 > 0)
			player.getVarsManager().sendVarOld(802, value1); // stronghold of
		// security emotes
		if (unlockedEmotes.contains(36))
			player.getVarsManager().sendVarOld(1085, 249852); // hallowen hand
		// emote
		int value2 = 0;
		...
		if (unlockedEmotes.contains(45))
			value2 += 32768;
		if (value2 > 0)
			player.getVarsManager().sendVarOld(313, value2); //
		player.getVarsManager().sendVarOld(313, 1);
		if (unlockedEmotes.contains(47))
			player.getVarsManager().sendVarOld(818, 1);
		player.getVarsManager().sendVarOld(465, 7);
		player.getVarsManager().sendVarOld(802, -1);
		player.getVarsManager().sendVarOld(1085, 249852);
		player.getVarsManager().sendVarOld(313, -1);
		player.getVarsManager().sendVarOld(2033, 1043648799);
		player.getVarsManager().sendVarOld(2032, 7341);
		player.getVarsManager().sendVarOld(1921, -893736236);
		player.getVarsManager().sendVarOld(1404, 123728213);
		player.getVarsManager().sendVarOld(2169, -1);
		player.getVarsManager().sendVarOld(2230, -1);
		player.getVarsManager().sendVarOld(1597, -1);
		player.getVarsManager().sendVarOld(1842, -1);
		player.getVarsManager().sendVarOld(2432, -1);
		player.getVarsManager().sendVarOld(1958, 534);
		player.getVarsManager().sendVarOld(2405, -1);
		player.getVarsManager().sendVarOld(2458, -1);
	}
