...
public class ItemSets {
	...
	public enum Sets { // Hours of finding id's :S - Sonic / + alex(dragonkk for the second part)

		AKRISAES(21768, 21736, 21738, 21740, 21742),
		GUTHANS(11850, 4724, 4726, 4728, 4730),
		VERACS(11856, 4753, 4755, 4757, 4759),
		KARILS(11852, 4732, 4734, 4736, 4738),
		AHRIMS(11846, 4708, 4710, 4712, 4714),
		DHAROKS(11848, 4716, 4718, 4720, 4722),
		TORAGS(11854, 4745, 4747, 4749, 4751),
		...
		THIRD_AGE_MELEE(11858, 10350, 10348, 10352, 10346),
		THIRD_AGE_RANGE(11860, 10334, 10330, 10332, 10336),
		THIRD_AGE_MAGE(11862, 10342, 10334, 10338, 10340),
		...
		,SPLITBARK(11876, 3385, 3387, 3393, 3391, 3389)
