...
public class FlyingEntityHunter {
	...
	{ new Item(12158, 1) /* Gold charm */, new Item(12159, 1) /*
																* Green
																* charm
																*/, new Item(12160, 1) /*
																						* Crimson
	...
	public enum FlyingEntities {
		...
		BABY_IMPLING(1028, 11238, 20, 25, 17, new Item[]
		{ new Item(946, 1), new Item(1755, 1), new Item(1734, 1), new Item(1733, 1), new Item(2347, 1), new Item(1985, 1) }, new Item[]
		{ new Item(1927, 1), new Item(319, 1), new Item(2007, 1), new Item(1779, 1), new Item(7170, 1), new Item(401, 1), new Item(1438, 1) }, new Item[]
		{ new Item(2355), new Item(1607), new Item(1743), new Item(379), new Item(1761) }, null),

		YOUNG_IMPLING(1029, 11240, 48, 65, 22, new Item[]
		{ new Item(361, 1), new Item(1901, 1), new Item(1539, 5), new Item(1784, 4), new Item(1523, 1), new Item(7936, 1), new Item(5970, 1) }, new Item[]
		...
		{ new Item(361, 1), new Item(365, 1), new Item(1897, 1), new Item(2007, 1), new Item(2011, 1), new Item(2293, 1), new Item(2327, 1), new Item(5970, 1) }, new Item[]
		{ new Item(247, 1), new Item(379, 1), new Item(385, 1), new Item(1883, 1), new Item(1885, 1), new Item(5755, 1), new Item(6969, 1), new Item(7170, 1), new Item(7178, 1), new Item(7188, 1),
			new Item(7754, 1), new Item(8244, 1), new Item(8526, 1) }, new Item[]
		{ new Item(373, 1), new Item(5406, 1), new Item(5755, 1), new Item(7170, 1), new Item(7178, 1), new Item(7178, 1), new Item(7188, 1), new Item(7754, 1), new Item(8244, 1), new Item(8526, 1),
			new Item(10136, 1), new Item(14831, 1), new Item(10137, 5) }, null),

		EARTH_IMPLING(1031, 11244, 126, 177, 36, new Item[]
		{ new Item(444, 1), new Item(557, 32), new Item(1441, 6), new Item(1442, 1), new Item(2353, 1), new Item(5104, 1), new Item(5535, 1), new Item(6032, 1), new Item(20904, 1),
			new Item(20914, 1), new Item(20942, 1), new Item(24216, 1), new Item(24767, 1) }, new Item[]
		{ new Item(237, 1), new Item(447, 1), new Item(1273, 1), new Item(454, 6), new Item(1487, 1), new Item(5311, 2), new Item(5294, 2) }, new Item[]
		{ new Item(448, 1), new Item(1606, 2), new Item(6035, 2), }, new Item[]
		{ new Item(1603, 1), new Item(5303, 1) }),
												...
												*/, new Item(555, 30) /*
																		...
																		*/, new Item(556, 60) /*
																								...
																								*/, new Item(559, 30) /*
																														* Body
																														* rune
																														*/, new Item(1448, 1), new Item(7937, 20) }, new Item[]
		{ new Item(564, 4), new Item(4694, 4) /*
												* Steam
												* rune
												*/, new Item(4696, 4) /*
																		* Dust
																			...
																			*/, new Item(450, 10) /*
																									...
																									*/, new Item(7208, 1) /*
																															...
																															*/, new Item(5760, 2), new Item(5321, 3) /*
																																										...
																																										* seed
																																										*/, }, new Item[]
		{ new Item(1391, 1), new Item(1601, 1) }),
		...
		{ new Item(12155, 25), new Item(12109, 1) /*
			...
			new Item(2151, 5) /*
								* Swamp
								* toad
								*/, new Item(12156, 1) /* Honeycomb */, new Item(1934, 14), new Item(6033, 12) /* Compost */, new Item(6010, 1) /* Marigolds */, new Item(12148, 3),
			new Item(12134, 1) /*
								* Evil
								* turnip
		...
		{ new Item(6328, 1) /*
			...
			new Item(1215, 1), new Item(6313, 1) /*
													...
													*/, new Item(892, 70), new Item(811, 70) /*
																								* Rune
																								* dart
																								*/, new Item(868, 40), new Item(1747, 16), new Item(140, 4), new Item(805, 40), new Item(25496, 4), }, new Item[]
		...
		KINGLY_IMPLING(7903, 15517, 434, 617, 91, new Item[]
		{ new Item(1705, Utils.random(3, 11)), new Item(1684, 3), new Item(1618, Utils.random(17, 34)), new Item(990, 2) }, new Item[]
		{ new Item(1631, 1), new Item(1615, 1), new Item(9341, 40 + Utils.random(30)), new Item(9342, 57), new Item(15511, 1), new Item(15509, 1), new Item(15505, 1), new Item(15507, 1),
			...
			new Item(1306, Utils.random(1, 2)), new Item(1249, 1) }, new Item[]
		{ new Item(9194, Utils.random(1, 71)) }, new Item[]
		{ new Item(7158, 1), new Item(2366, 1), new Item(6571, 1) }),
