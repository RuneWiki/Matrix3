...
public class TicketSystem {
	...
	public static void openNextTicket(final Player player) {
		...
		if (target.getInterfaceManager().containsDialogueInterface() || target.getControlerManager().getControler() != null || target.getInterfaceManager().containsInventoryInter() || target.getInterfaceManager().containsScreenInterface()) {
